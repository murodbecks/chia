...
class ComparisonTests(unittest.TestCase):
    def setUp(self):
        self.job = dict(request=dict(code_sha256='base', cluster_sha256='cluster', precision='bf16', model='chronos2', stage='bringup'),
                        result=dict(returncode=0, failure=None, timeout=False, pci='card',
                                    cluster_sha256='cluster', precision='bf16', model='chronos2',
                                    verdict=dict(passed=True, stage='bringup', model_key='chronos2', suite_sha256='suite',
