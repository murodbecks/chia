...
class ComparisonTests(unittest.TestCase):
    def setUp(self):
        self.job = dict(request=dict(code_sha256='base', cluster_sha256='cluster', precision='bf16', model='esm2', stage='bringup'),
                        result=dict(returncode=0, failure=None, timeout=False, pci='card',
                                    cluster_sha256='cluster', precision='bf16', model='esm2',
                                    verdict=dict(passed=True, stage='bringup', model_key='esm2', suite_sha256='suite',
