...
class LoopTests(unittest.TestCase):
    ...
    def test_compact_status_preserves_failure_quality_identity_and_legacy_response(self):
        ...
        self.assertEqual(compact['details']['tool'], 'parakeet_log')
    ...
    def test_compact_status_keeps_old_pending_and_reference_study_details(self):
        ...
        for job in ('study', 'pending-reference'):
            self.assertEqual(compact[job]['details']['tool'], 'parakeet_status')
    ...
    def test_log_registered_and_uses_job_archived_endpoint(self):
        ...
        self.assertIn('parakeet_log', names)
    ...
    def test_run_punctuation_cannot_create_nested_mcp_config_keys(self):
        ...
        self.assertRegex(name, r'^parakeet_[a-f0-9]{16}$')
        ...
        agent.agent_name, agent.config = 'parakeet-worker', None
    ...
    def test_references_are_reused_only_from_the_same_evaluator(self):
        ...
        (earlier / 'harness/evaluate.py').write_bytes((loop.HERE / 'evaluate.py').read_bytes())
    ...
    def test_agent_environment_defaults_older_manifests_to_opencode(self):
        self.assertEqual(loop.agent_environment({}), {'PARAKEET_WORKER_BACKEND': 'opencode',
                                                      'PARAKEET_SUPERVISOR_BACKEND': 'opencode'})
        ...
        self.assertEqual(loop.agent_environment(manifest), {
            'PARAKEET_WORKER_BACKEND': 'claude', 'PARAKEET_WORKER_MODEL': 'claude-opus-5-5',
            'PARAKEET_SUPERVISOR_BACKEND': 'opencode', 'PARAKEET_SUPERVISOR_MODEL': 'zai-coding-plan/glm-5.3'})
    ...
    def test_frozen_environment_uses_archive_and_checks_docs_and_registry(self):
        ...
        self.assertEqual(env['PARAKEET_REPOSITORY_ROOT'], '/workspace/original-repository')
